...
if ( ! class_exists( 'Tripzzy\Core\Emails\AdminBookingEmail' ) ) {
	...
	class AdminBookingEmail extends EmailBase {
					...
					<tr>
						<td style="border-top:3px solid #de5b09; padding:20px">
							<div class="tripzzy-admin" style="color: #5a5a5a; font-family: Roboto, sans-serif; margin: auto;">
								...
								<p style="text-align:center"><a href="%DASHBOARD_URL%" style="padding: 10px 15px;border: 2px solid #de5b09; text-decoration: none;border-radius: 3px;">View All booking</a></p>
		...
		public function init_reply_to() {
			...
			$reply_to      = isset( $checkout_info['billing_email'] ) ? $checkout_info['billing_email'] : '';
