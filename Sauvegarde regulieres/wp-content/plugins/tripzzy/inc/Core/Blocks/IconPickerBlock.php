...
if ( ! class_exists( 'Tripzzy\Core\Blocks\IconPickerBlock' ) ) {
	/**
	 * Tripzzy Icon Picker Block Class.
	 *
	 * @since 1.0.8
	 */
	class IconPickerBlock extends BlocksBase {
		/**
		 ...
		 * @var string
		 */
		protected static $block_slug = 'icon-picker';
