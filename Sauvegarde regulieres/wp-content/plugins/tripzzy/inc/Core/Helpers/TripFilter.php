	...
	class TripFilter {
		...
		public static function render_trip_filters() {
			...
			if ( self::has_active_filters() ) :
				...
				<div id="tz-filter-widget-area" class="tz-filter-widget-area collapsed mobile-sidebar">
				...
				(function(){
				  function initTripzzyFilterToggle(){
					...
					var toggleWrapper = toggleBtn ? toggleBtn.parentNode : null;
					var toggleParent = toggleWrapper ? toggleWrapper.parentNode : null;
					...
					function relocateToggle(){
					  if (!toggleBtn) return;
					  var toggleWrapper = toggleBtn.parentNode;
					...
					if (window.innerWidth <= 768) { filterArea.classList.add('collapsed'); }
					relocateToggle();
