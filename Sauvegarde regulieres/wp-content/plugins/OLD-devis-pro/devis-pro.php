...
class Devis_Pro {
    ...
    public function shortcode_form($atts) {
        ...
        // Traitement du formulaire (nouveau format)
        ...
        // Traitement du formulaire (ancien format - compatibilité)
        if (isset($_POST['send']) && $_POST['send'] == '1' && !empty($_POST['email']) && !empty($_POST['tel'])) {
            $result = $this->process_old_form($_POST, $atts);
            if ($result['success']) {
                ob_start();
                include DEVIS_PRO_PATH . 'views/form-success.php';
                return ob_get_clean();
        ...
        ob_start();
        // Utiliser le formulaire legacy (compatible avec l'ancien plugin)
