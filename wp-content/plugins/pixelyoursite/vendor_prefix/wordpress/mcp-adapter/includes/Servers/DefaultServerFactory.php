...
namespace PYS_PRO_GLOBAL\WP\MCP\Servers;

use PYS_PRO_GLOBAL\WP\MCP\Core\McpAdapter;
use PYS_PRO_GLOBAL\WP\MCP\Infrastructure\ErrorHandling\ErrorLogMcpErrorHandler;
use PYS_PRO_GLOBAL\WP\MCP\Infrastructure\Observability\NullMcpObservabilityHandler;
use PYS_PRO_GLOBAL\WP\MCP\Transport\HttpTransport;
/**
 * Factory for creating the default WordPress MCP server.
 *
...
class DefaultServerFactory
{
    ...
    public static function create(): void
    {
         ...
         * }
         */
        $config = apply_filters('pys_pro_mcp_adapter_default_server_config', $wordpress_defaults);
