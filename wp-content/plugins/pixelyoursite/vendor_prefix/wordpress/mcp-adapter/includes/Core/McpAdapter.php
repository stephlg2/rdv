...
use PYS_PRO_GLOBAL\WP\MCP\Abilities\DiscoverAbilitiesAbility;
use PYS_PRO_GLOBAL\WP\MCP\Abilities\ExecuteAbilityAbility;
use PYS_PRO_GLOBAL\WP\MCP\Abilities\GetAbilityInfoAbility;
use PYS_PRO_GLOBAL\WP\MCP\Cli\McpCommand;
...
use PYS_PRO_GLOBAL\WP\MCP\Servers\DefaultServerFactory;
use WP_Error;
/**
 * WordPress MCP Registry - Main class for managing multiple MCP servers.
 */
