...
class ListToolsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     */
    public function __construct(array $tools, ?string $nextCursor = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($tools, self::asStringOrNull($data['nextCursor'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
