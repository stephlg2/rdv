...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Server\Resources\DTO;
...
class ListResourceTemplatesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     */
    public function __construct(array $resourceTemplates, ?string $nextCursor = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($resourceTemplates, self::asStringOrNull($data['nextCursor'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
