...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Server\Core\DTO;
...
class CompleteResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(CompleteResultCompletion $completion, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($completion, self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
