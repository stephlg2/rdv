...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Server\Tools\DTO;

use PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\DTO\Result;
use PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\Factory\ContentBlockFactory;
use PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface;
...
class CallToolResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(array $content, ?array $_meta = null, ?array $structuredContent = null, ?bool $isError = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($content, self::asArrayOrNull($data['_meta'] ?? null), self::asArrayOrNull($data['structuredContent'] ?? null), self::asBoolOrNull($data['isError'] ?? null));
    }
    /**
