...
class GetPromptResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(array $messages, ?array $_meta = null, ?string $description = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($messages, self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['description'] ?? null));
    }
    /**
