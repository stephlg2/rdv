...
class ListResourcesResult extends PaginatedResult implements ServerResultInterface
{
     ...
     */
    public function __construct(array $resources, ?string $nextCursor = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($resources, self::asStringOrNull($data['nextCursor'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
