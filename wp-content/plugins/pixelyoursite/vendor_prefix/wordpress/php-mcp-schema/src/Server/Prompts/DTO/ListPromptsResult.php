...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Server\Prompts\DTO;
...
class ListPromptsResult extends PaginatedResult implements ServerResultInterface
{
     ...
     */
    public function __construct(array $prompts, ?string $nextCursor = null, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($prompts, self::asStringOrNull($data['nextCursor'] ?? null), self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
