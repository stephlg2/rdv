...
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\Union\SingleSelectEnumSchemaInterface;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\UntitledSingleSelectEnumSchema;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\TitledSingleSelectEnumSchema;
/**
...
final class SingleSelectEnumSchemaFactory
{
     ...
     */
    public const REGISTRY = ['string' => UntitledSingleSelectEnumSchema::class];
    /**
