...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Client\Sampling\DTO;
...
use PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\Factory\SamplingMessageContentBlockFactory;
...
class CreateMessageResult extends Result implements ClientResultInterface
{
     ...
     */
    public function __construct(string $model, string $role, array $content, ?array $_meta = null, $stopReason = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['model']), $role, $content, self::asArrayOrNull($data['_meta'] ?? null), $stopReason);
    }
    /**
