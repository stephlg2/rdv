...
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\Union\MultiSelectEnumSchemaInterface;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\UntitledMultiSelectEnumSchema;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\TitledMultiSelectEnumSchema;
/**
...
final class MultiSelectEnumSchemaFactory
{
     ...
     */
    public const REGISTRY = ['array' => UntitledMultiSelectEnumSchema::class];
    /**
