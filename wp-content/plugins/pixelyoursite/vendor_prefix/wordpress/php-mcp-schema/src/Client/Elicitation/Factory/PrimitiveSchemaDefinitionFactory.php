...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\Factory;

use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\Union\PrimitiveSchemaDefinitionInterface;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\StringSchema;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\NumberSchema;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\DTO\BooleanSchema;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Elicitation\Factory\EnumSchemaFactory;
/**
...
final class PrimitiveSchemaDefinitionFactory
{
     ...
     */
    public const REGISTRY = ['number' => NumberSchema::class, 'integer' => NumberSchema::class, 'boolean' => BooleanSchema::class, 'array' => EnumSchemaFactory::class, 'string' => StringSchema::class];
    /**
