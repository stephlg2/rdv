...
class ElicitResult extends Result implements ClientResultInterface
{
     ...
     */
    public function __construct(string $action, ?array $_meta = null, ?array $content = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($action, self::asArrayOrNull($data['_meta'] ?? null), self::asStringMapOrNull($data['content'] ?? null));
    }
    /**
