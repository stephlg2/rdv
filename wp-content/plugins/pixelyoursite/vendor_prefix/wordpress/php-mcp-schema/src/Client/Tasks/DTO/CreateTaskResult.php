...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Client\Tasks\DTO;
...
class CreateTaskResult extends Result
{
     ...
     */
    public function __construct(Task $task, ?array $_meta = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self($task, self::asArrayOrNull($data['_meta'] ?? null));
    }
    /**
