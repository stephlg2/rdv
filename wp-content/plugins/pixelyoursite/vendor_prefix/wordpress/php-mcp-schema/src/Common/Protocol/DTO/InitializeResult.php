...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\DTO;

use PYS_PRO_GLOBAL\WP\McpSchema\Common\Lifecycle\DTO\Implementation;
use PYS_PRO_GLOBAL\WP\McpSchema\Common\Traits\ValidatesRequiredFields;
use PYS_PRO_GLOBAL\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities;
use PYS_PRO_GLOBAL\WP\McpSchema\Server\Lifecycle\Union\ServerResultInterface;
/**
...
class InitializeResult extends Result implements ServerResultInterface
{
     ...
     */
    public function __construct(string $protocolVersion, ServerCapabilities $capabilities, Implementation $serverInfo, ?array $_meta = null, ?string $instructions = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['protocolVersion']), $capabilities, $serverInfo, self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['instructions'] ?? null));
    }
    /**
