...
namespace PYS_PRO_GLOBAL\WP\McpSchema\Common\Tasks\DTO;

use PYS_PRO_GLOBAL\WP\McpSchema\Common\Protocol\DTO\Result;
use PYS_PRO_GLOBAL\WP\McpSchema\Client\Lifecycle\Union\ClientResultInterface;
...
class CancelTaskResult extends Result implements ClientResultInterface, ServerResultInterface
{
     ...
     */
    public function __construct(string $taskId, string $status, string $createdAt, string $lastUpdatedAt, int $ttl, ?array $_meta = null, ?string $statusMessage = null, ?int $pollInterval = null)
    {
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(self::asString($data['taskId']), $status, self::asString($data['createdAt']), self::asString($data['lastUpdatedAt']), self::asInt($data['ttl']), self::asArrayOrNull($data['_meta'] ?? null), self::asStringOrNull($data['statusMessage'] ?? null), self::asIntOrNull($data['pollInterval'] ?? null));
    }
    /**
