...
if ( ! class_exists( 'Tripzzy\Core\Taxonomies\TripActivitiesTaxonomy' ) ) {
	/**
	 * Tripzzy Taxonomy Class.
	 *
	 * @since 1.0.0
	 */
	class TripActivitiesTaxonomy extends TaxonomyBase {
		use DataTrait;
		 ...
		 * @var string
		 */
		protected static $taxonomy = 'tripzzy_trip_activities';
		...
		protected static function taxonomy_args() {
			$labels = array(
				'name'              => _x( 'Trip Activities', 'taxonomy general name', 'tripzzy' ),
				'singular_name'     => _x( 'Trip Activities', 'taxonomy singular name', 'tripzzy' ),
				'search_items'      => __( 'Search Trip Activities', 'tripzzy' ),
				'all_items'         => __( 'All Trip Activities', 'tripzzy' ),
				'parent_item'       => __( 'Parent Trip Activities', 'tripzzy' ),
				'parent_item_colon' => __( 'Parent Trip Activities:', 'tripzzy' ),
				'edit_item'         => __( 'Edit Trip Activities', 'tripzzy' ),
				'update_item'       => __( 'Update Trip Activities', 'tripzzy' ),
				'add_new_item'      => __( 'Add New Trip Activities', 'tripzzy' ),
				'new_item_name'     => __( 'New Trip Activities', 'tripzzy' ),
				'menu_name'         => __( 'Trip Activities', 'tripzzy' ),
				'back_to_items'     => '← ' . __( 'Go to Trip Activities', 'tripzzy' ),
			);
			...
			$args = array(
				...
				'query_var'          => true,
				'rewrite'            => array(
					'slug'       => self::$slugs['tripzzy_trip_activities_base'],
					'with_front' => false,
				),
				'object_types'       => self::$object_types, // Where to add This taxonomy.
				'icon'               => 'fa-solid fa-person-hiking', // only for trip info section default icon.
				'priority'           => 35,
			);
			return $args;
		}
