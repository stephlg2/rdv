...
<div class="devis-pro-form">
    ...
    <form method="post" id="<?php echo esc_attr($form_unique_id); ?>" novalidate>
...
<script>
(function() {
    var form = document.getElementById('devis-pro-form');
    if (!form) return;
...
(function() {
    ...
    form.addEventListener('submit', function(e) {
        // Si déjà un token reCAPTCHA, laisser passer
