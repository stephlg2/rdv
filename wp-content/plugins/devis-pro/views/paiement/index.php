            ...
            <?php if ($payment_data) : ?>
                <div class="payment-action">
                    ...
                    <form method="post" action="<?php echo esc_url($payment_data['payment_url']); ?>" class="payment-form" accept-charset="UTF-8">
                        ...
                        <input type="hidden" name="url_retour_ok" value="<?php echo esc_url($payment_data['url_retour_ok']); ?>">
                        <input type="hidden" name="url_retour_err" value="<?php echo esc_url($payment_data['url_retour_err']); ?>">
                        <input type="hidden" name="lgue" value="<?php echo esc_attr($payment_data['lgue']); ?>">
