...
class Devis_Pro
{
    ...
    private function __construct()
    {
        ...
        add_action('init', function() {
            if (isset($_GET['monetico_action']) && $_GET['monetico_action'] === 'notify') {
                $this->rdvasie_handle_monetico_callback();
            }
        });

        add_action('monetico_api_callback', array($this, 'rdvasie_handle_monetico_callback'));
    ...
    function rdvasie_handle_monetico_callback()
    {
