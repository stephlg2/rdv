...
if ( ! class_exists( 'Tripzzy\Core\Forms\Inputs\Number' ) ) {
	/**
	 * Number Input.
	 *
	 * @since 1.0.0
	...
	class Number extends Text {
		 ...
		 * @since 1.0.0
		 */
		protected static $field_type = 'number';
		...
		public static function init_attribute() {
			add_filter( 'tripzzy_filter_field_attributes', array( 'Tripzzy\Core\Forms\Inputs\Number', 'register_attribute' ) );
		}
		...
		public static function register_attribute( $attribute ) {
			$attribute[ self::$field_type ] = array(
				'label' => __( 'Number', 'tripzzy' ),
				'class' => 'Tripzzy\Core\Forms\Inputs\Number',
				'attr'  => array(
					'step',
					'min',
					'max',
