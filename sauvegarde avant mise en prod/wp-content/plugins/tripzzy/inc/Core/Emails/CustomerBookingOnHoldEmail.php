...
if ( ! class_exists( 'Tripzzy\Core\Emails\CustomerBookingOnHoldEmail' ) ) {
	 ...
	 * @since 1.1.8
	 */
	class CustomerBookingOnHoldEmail extends EmailBase {
		...
		public static function email_subject() {
			return self::$settings['customer_booking_on_hold_notification_subject'] ?? 'Booking On Hold';
		}

		/**
		 * Customer Booking on Hold Email content.
		 *
		 * @since 1.0.0
		...
		public static function email_content() {
			...
			$content  = $settings['customer_booking_on_hold_notification_content'] ?? '';
					...
					<tr>
						<td style="border-top:3px solid #de5b09; padding:20px">
							<div class="tripzzy-admin" style="color: #5a5a5a; font-family: Roboto, sans-serif; margin: auto;">
								...
								<p style="line-height: 1.55; font-size: 14px;">Your booking #%BOOKING_ID% is on hold.</p>
							</div>
						</td>
					</tr>
				</tbody>
		...
		public static function get_tags() {
			...
			return apply_filters( 'tripzzy_filter_customer_booking_on_hold_email_tags', $tags );
		}
