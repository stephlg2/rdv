<?php
/**
 * Tripzzy Shortcode For Blocks Section. A Legacy Shortcode for archive page.
 *
 * @since 1.0.6
 * @package tripzzy
 */
...
if ( ! class_exists( 'Tripzzy\Core\Shortcodes\BlockTemplates\TripsArchiveShortcode' ) ) {
	/**
	 * Checkout Shortcode Class.
	 *
	 * @since 1.0.6
	 */
	class TripsArchiveShortcode extends ShortcodeBase {
		/**
		 * Shortcode name.
		 *
		 * @since 1.0.6
		 * @var string
		 */
		protected static $shortcode = 'TRIPZZY_TRIPS_ARCHIVE_BLOCK';
		...
		protected static function shortcode_args() {
			$args = array(
				...
				'callback'  => array( 'Tripzzy\Core\Shortcodes\BlockTemplates\TripsArchiveShortcode', 'render' ),
			);
			return $args;
		}
		...
		public static function render( $atts, $content = '' ) {
			...
			ob_end_clean();
			return Strings::trim_nl( $content );
		}
	}
}
